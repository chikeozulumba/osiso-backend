...
export class ModelsRepository<T, K extends ModelsEntity> extends Repository<T> {
  async get(
    id: string,
    relations: string[] = [],
  ...
  transform(model: T, transformOptions: IObject = {}): K {
    return plainToClass(
      transformOptions.entity || ModelsEntity,
      model,
      transformOptions,
    ) as K;
  }
